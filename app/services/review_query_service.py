...
class ReviewQueryService:
    ...
    def search_reviews_in_chroma(self, query: str, n_results: int = 5, filter_metadata: dict = None):
        ...
        return self.chroma_service.query_embeddings(
            query_embedding=query_embedding, n_results=n_results, filter_metadata=filter_metadata
        )

    def generate_response_from_gpt(self, query: str, filter_metadata: dict = None) -> str:
